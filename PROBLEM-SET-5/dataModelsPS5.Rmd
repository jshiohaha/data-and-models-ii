...
plot(sensVsSpecPerf, colorize=F, colorize.palette=rev(rainbow(256)))
grid()
...
plot(precVsRecallPerf, colorize=F, colorize.palette=rev(rainbow(256)))
grid()
