...
# Change as needed
workingDirectory = "~/Desktop/School/ML/data-and-models-ii/PROBLEM-SET-5"
...
\noindent
\textbf{Question}: Compare the models and comment. \\

\noindent
By looking at AIC values, the 'full' logistic regression model using all the features is the better model. The null model has an AIC of 2901 while the full model has one of 2613.
