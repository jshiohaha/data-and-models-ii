...
# Change as needed
workingDirectory = "/Users/reidgahan/Desktop/School/ML/data-and-models-ii/PROBLEM-SET-5"
...
# I'm getting an error here... something with "colname"length of 'dimnames' [2] not equal to array extent"" -- Reid
acc(t, FALSE)
```
...
Jcost = function(y, h) {
  ...
  return( (1/n)*sum((-y*log(h)) - ((1-y)*log(1-h))) )
}
