...
# TODO: should this be rounded as TenYearCHD is a nominal response variable?
trainset_mean <- round(mean(trainset$TenYearCHD))
...
faslepositive <- TenYearCHDAsTable[names(TenYearCHDAsTable)!=trainset_mean]
ppv = truepositive / (truepositive + faslepositive)
psp("Postive Predictive Rate (precision): ", ppv, 2)

# - Which error type seems worse and thus should be considered along with accuracy in your predictions below? Why?
# -- TODO: Ask Keck exactly what this means?
...
# TODO: how to create a null model in R?
...
# TODO: output same statistics for null model
modelFULLPredictions <- predict(modelFULL, testset)

modelFULLAIC <- AIC(modelFULL)
psi("Full Model AIC: ", modelFULLAIC)
modelFULLll <- logLik(modelFULL)
psi("Full Model Log likelihood: ", modelFULLll)
modelFULLDeviance <- modelFULL$deviance
psi("Full Model Deviance: ", modelFULLDeviance)

# Calculates llh, llhNull, G2, McFadden, r2ML, r2CU 
pR2(model)
